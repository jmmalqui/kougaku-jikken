...
class setumei(MesaStackVertical):
    def __init__(self,parent) -> None:
        ...
        self.set_background_color("#F3F3F3")
        self.text1=NormalText(self,"本体サイズ 　　:  361mm×244mm×19.9mm")
        ...
        self.text6=NormalText(self,"ソフトウェア 　:  Windows11 Home 64ビット")
        self.text7=NormalText(self,"プロセッサ　 　:  インテルCore i7-1355U プロセッサー")
        self.text8=NormalText(self,"バッテリー　 　:  通常デバイス使用で最大9.5時間")
        self.set_margin(0,6)
        self.parent.add_element(self)
