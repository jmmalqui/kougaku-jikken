...
class PCname2(MesaTextLabel):
    def __init__(self, parent) -> None:
        ...
        self.set_text_color("black")
        self.set_background_color("#F3F3F3")
        self.set_text("Spectre x360 6F8L0PA-AAAB")
        self.parent.add_element(self)
...
class setumei(MesaStackVertical):
    def __init__(self,parent) -> None:
        ...
        self.set_fixed_height(300)
        self.set_background_color("#F3F3F3")
        self.text1=NormalText(self,"本体サイズ 　　:  299mm×220mm×16.5mm")
        self.text2=NormalText(self,"スクリーン 　　:  13.5インチ")
        self.text3=NormalText(self,"解像度 　　　　:  1920×1280")
        self.text4=NormalText(self,"メモリ　　 　　:  16GB")
        self.text5=NormalText(self,"ストレージ 　　:  512GB SSD")
        self.text6=NormalText(self,"ソフトウェア 　:  Windows11 Pro")
        self.text7=NormalText(self,"プロセッサ　 　:  インテルCore i7-13700H プロセッサー")
        self.text8=NormalText(self,"バッテリー　 　:  通常デバイス使用で最大16時間")
        self.set_margin(0,6)
        self.parent.add_element(self)
...
class textbox1(MesaStackHorizontal):
    def __init__(self, parent) -> None:
        ...
        self.number = number(self.daisu, "  1")
        self.parent.add_element(self)
