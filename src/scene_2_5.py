...
class PCname2(MesaTextLabel):
    def __init__(self, parent) -> None:
        ...
        self.set_text_color("black")
        self.set_background_color("#F3F3F3")
        self.set_text("TUF Dash F15 FX5172C")
        self.parent.add_element(self)
...
class imagebox(MesaStackVertical):
    def __init__(self, parent, image) -> None:
        super().__init__(parent)
        self.set_fixed_width(385)
        self.set_fixed_height(215)
        self.set_background_color("#F3F3F3")
...
class setumei(MesaStackVertical):
    def __init__(self,parent) -> None:
        ...
        self.set_background_color("#F3F3F3")
        self.text1=NormalText(self,"本体サイズ 　　:  360mm×252mm×19.9mm")
        ...
        self.text6=NormalText(self,"ソフトウェア 　:  Windows10 Home 64ビット")
        self.text7=NormalText(self,"プロセッサ　 　:  インテルCore i7-11370H プロセッサー")
        self.text8=NormalText(self,"バッテリー　 　:  通常デバイス使用で最大12.6時間")
        self.set_margin(0,6)
        self.parent.add_element(self)
