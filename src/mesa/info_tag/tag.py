...
class InfoTagHandler:
    def __init__(self, core) -> None:
        ...
        self.tag_font = pg.font.SysFont("ipamincho", 15, True, True)
...
class InfoTag:
    def __init__(self, handler, information, level: TagProperty) -> None:
        ...
        self.tick = 0
        self.x = DynamicObject(self.animation, 0)
        self.y = DynamicObject(self.animation, 0)
        ...
        self.x.go_to(60, 60, MesaAnimationCurves.EASE_OUT_CUBIC)
        self.gap = 20
    ...
    def set_id(self, id):
        ...
        self.y.go_to(-1 * y_difference, 30, MesaAnimationCurves.EASE_OUT_SINE)
    ...
    def update(self):
        ...
        if self.tick == self.level.ttl:
            self.alpha.go_to(0, self.vanishing_time, MesaAnimationCurves.EASE_IN_SINE)
